    ...
    pub fn get_track_metadata_with_cd_inheritance(
        ...
        let mut resp = match track_row {
            Some(r) => TrackMetadataResponse {
                ...
                cover_mime: r.get(8)?,
                cover_data: r.get(9)?,
                replay_gain_track_gain_db: r.get(10)?,
                replay_gain_track_peak: r.get(11)?,
                replay_gain_album_gain_db: r.get(12)?,
                replay_gain_album_peak: r.get(13)?,
                file_type: r.get(14)?,
                raw_size_bytes: r.get(15)?,
                ..Default::default()
            },
            None => {
